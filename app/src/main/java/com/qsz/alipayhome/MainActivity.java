...
public class MainActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设置沉浸式状态栏，可参考http://github.com/gyf-dev/ImmersionBar
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
        ...
        int argbDouble = Color.argb(absVerticalOffset * 2, Color.red(mMaskColor), Color.green(mMaskColor),
                Color.blue(mMaskColor));
        // appBarLayout上滑一半距离后小图标 应该由渐变全透明
        ...
        if (absVerticalOffset <= totalScrollRange/2){
            ...
            // appBarlayout上滑一半距离后小图标应该由渐变 到全透明
